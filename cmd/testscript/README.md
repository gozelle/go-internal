```
The testscript command runs github.com/gozelle/go-internal/testscript scripts
...
github.com/gozelle/go-internal/testscript. The special filename "-" is
interpreted as the standard input.

As a special case, supporting files/directories in the .gomodproxy subdirectory
will be served via a github.com/gozelle/go-internal/goproxytest server which
...
github.com/gozelle/go-internal/goproxytest for details on the format of these
files/directories.
